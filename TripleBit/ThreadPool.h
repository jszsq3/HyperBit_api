...
private:
	...
	static CXThreadPool* cxworkPool, * cxchunkPool, * cxpartitionPool, * cxscanjoinPool;
...
public:
	static CXThreadPool& getWorkPool();
	static CXThreadPool& getChunkPool();
	static CXThreadPool& getPartitionPool();
	static CXThreadPool& getScanjoinPool();
	static void createAllPool();
	static void deleteAllPool();
	static void waitAllPoolComplete();
	~CXThreadPool();
